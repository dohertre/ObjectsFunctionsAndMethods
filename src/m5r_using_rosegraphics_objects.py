...
#              The middle of the page like in a coordinate axis
#
...
#            window = rg.RoseWindow(100, 200, 'Empty Window')
#
...
#                center, radius and fill circle
#
#     f. What does a RoseWindow RENDER method do?
#            Draws all the objects on the window
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            Close_on_mouse_click is always necessary because it acts as a way to close the window while it's running besides the x
#
